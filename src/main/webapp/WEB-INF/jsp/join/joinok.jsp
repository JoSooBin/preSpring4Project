...
<div id = "main margin30">
    ...
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item "><button type="button" class="btn btn-success btn-sm" disabled>가입완료</button></li>
    </ul>
    ...
    <div class="jumbotron margin1050 bg-info text-white">
        <h1>회원가입을 축하드립니다</h1>
        <p class="30">게시판 글작성, 쇼핑몰 이용등의 일부 서비스는 실명확인 후 이용하실 수 있습니다<br>실명확인후에도 가입하신 아이디는 변경할 수 없습니다</p>
        <hr class="bg-warning">
        <p>회원가입 이후 아이디와 비밀번호로 일반회원으로 로그인하셔서 추가 인적사항등을 등록해주시기 바랍니다<br>Lorem Ipsom과 함께 즐거운 시간 되십시오</p>
    </div>
