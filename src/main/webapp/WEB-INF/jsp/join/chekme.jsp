...
<div id = "main margin30">
            ...
            <div class="row">
                <div class="col-5 offset-1">
                    <div class="form-group row">
                        ...
                        <input type="text" id="name" name="name" class="form-control col-7 border-danger">
                    </div>
                    <div class="form-group row">
                        ...
                        <select id="birth2" name="birth2" class="form-control col-2">
                            <option>-월-</option><option>01</option>
                            <option>02</option><option>03</option>
                            <option>04</option><option>05</option>
                        </select>&nbsp;
                        <select id="birth3" name="birth3" class="form-control col-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="custom-control custom-radio text-danger pushgender">
                            <input type="radio" id="feamle" name="gender" class="custom-control-input" value="f">
                            <label for="feamle" class="custom-control-label">여자</label>
                        </div>
                    </div>
                </div>
                <div class="col-5">
                    <ul class="text-primary font-weight-bold">
                        ...
                        <li>이름, 생년월일과 성별은 <span class="text-danger">추후 변경 할 수 없습니다</span></li>
    ...
    <div class="card card-body bg-light margin1050">
        ...
        <form>
            <div class="row">
                <div class="col-5 offset-1">
                    <div class="form-group row">
                        ...
                        <input type="text" id="name2" name="name" class="form-control col-6 border-warning">
                    </div>
                    <div class="form-group row">
                        <label for="jumin1" class="col-4 col-form-label text-warning">주민번호</label>
                        <input type="text" id="jumin1" name="name" class="form-control col-3 border-warning">&nbsp;
                        <label class="col-form-label">&ndash;</label>&nbsp;
                        <input type="text" id="jumin2" name="name" class="form-control col-3 border-warning">
                    </div>
                    <div class="form-group row">
            ...
            <div class="row margin30">
                <div class="col-12 text-center">
                    <button type="button" id="check2btn" class="btn btn-primary"><i class="bi bi-check"></i>확인하기</button>
