...
<div id = "main margin30">
    ...
    <div class="margin100">
        <h2>사이트 이용약관</h2>
        <small class="text-muted">회원가입을 위해 아래 사이트 이용약관 &middot; 개인정보 수집 및 이용에 대한 안내를 읽고 동의해주세요</small>
        <hr>
    </div>
...
Copyright © Kakao Corp. All rights reserved.</textarea>
    ...
    <div class="text-center bg-light">
        <button type="button" id="okagree" class="btn btn-success">모두 동의 합니다</button>
